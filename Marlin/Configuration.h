...
#define STRING_CONFIG_H_AUTHOR "(Mauricio JOST, Anycubic I3)" // Who made the changes.
 ...
 */
//#define S_CURVE_ACCELERATION // MJOST TO TRY
...
#define PROBING_MARGIN 15 // stay away from screws for inductive sensor
